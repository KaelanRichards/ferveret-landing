...
const FounderCard = (props: FounderCardProps) => {
  return (
    <div className="shadow rounded-md	bg-primary-1100 flex flex-col flex-shrink-0 p-6 h-auto lg:w-1/2 w:5/6">
      <div className="p-5">
        <img
      ...
      <p className="text-gray-1200 text-base text center px-5">
        {props.description}
      </p>
    </div>
  );
