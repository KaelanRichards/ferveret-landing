...
const VerticalFeatures = () => {
  ...
  return (
    <div className="md:grid-rows-10">
      <div className="flex flex-col items-center lg:py-60 pt-28 bg-gray-1300  px-4 sm:px-12 md:px-16 lg:px-60">
        <div
          data-aos="fade-up"
          className="p-6 flex-shrink-0 shadow rounded-md	bg-primary-1100"
        >
          <h1 className="lg:text-5xl text-3xl font-bold text-gray-1200 p-3 w-full text-center">
            Data centers are dirty and expensive{" "}
          </h1>
          <p className="text-1xl md:text-2xl text-gray-1200 p-3 text-center ">
          ...
          <p className="md:text-2xl text-1xl text-gray-1200 p-1 w-full text-center">
            Eliminates this waste of money and the associated emissions.
          </p>
        </div>
      </div>

      <div className="max-w-screen-xlg bg-gray-1100 lg:pt-56 pt-24 px-4 sm:px-12 md:px-16 xl:px-60">
        <div
          className="text-center lg:p-12 p-6 flex-shrink-0 shadow rounded-md	bg-gray-2200"
          data-aos="fade-up"
        >
          <h2
          ...
          <ul className="flex flex-col text-left lg:text-2xl text-1xl py-6">
            <li className="text-primary-1100 ">
          ...
          <p className="text-primary-1100 text-center lg:text-3xl text-2xl">
            All these issues are consequence of the poor heat removal capability
            of air cooling
          </p>
        </div>
      </div>
      <div className="pt-6 px-4 sm:px-12 md:px-16 xl:px-60 bg-gray-1100">
        <div
      ...
      <div className="max-w-screen-xlg bg-gray-1100 px-4 sm:px-12 md:px-16 xl:px-60">
        <div
          className="text-center lg:p-12 p-6 flex-shrink-0 shadow rounded-md	bg-gray-2200"
          data-aos="fade-up"
        >
      ...
      <div className="px-4 pt-6 sm:px-12 md:px-16 xl:px-60 bg-gray-1100">
        <div
      ...
      <div className="font-bold lg:text-center text-gray-1200 bg-gray-1300 text-4xl text-center md:text-6xl lg:pt-44 pt:12 lg:pb-12 pt-8 px-4 sm:pl-12 md:pl-16 lg:pl-35 ">
        <h2 data-aos="fade-up">
          <span className="gradient">ferveret</span> technology
        </h2>
      </div>
      <div className="flex xl:flex-row flex-col justify-center bg-gray-1300 pt-4 pb-52 ">
        ...
        >
          <div className="lg:p-12 p-6 flex-shrink-0 shadow rounded-md	bg-primary-1100">
            <div className="font-bold md:text-center text-gray-1200 text-3xl text-center md:text-4xl">
      ...
      <div className="flex xl:flex-row flex-col justify-center bg-gray-1300 pt-4 pb-52 px:8 sm:px-12 md:px-16 lg:px-60 py-8">
        <div className="lg:p-12 p-6 flex-shrink-0 shadow rounded-md	bg-primary-1100 w-full">
          <div className="font-bold md:text-center text-gray-1200 text-3xl text-center md:text-4xl ">
